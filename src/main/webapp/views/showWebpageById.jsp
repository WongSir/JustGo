                    ...
                    <td style="word-break:break-all; word-wrap:break-word;">
                        <c:forEach items="${webpage.namedEntity.get('nr')}" var="word">
                            <a class="btn btn-outline btn-info btn-sm" style="margin: 1px"
                               href="${pageContext.request.contextPath}/views/showRelatedInfo?query=namedEntity.nr:${word}">${word}</a>
                        </c:forEach>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="word-break:break-all; word-wrap:break-word;">
                        <c:forEach items="${webpage.namedEntity.get('ns')}" var="word">
                            <a class="btn btn-outline btn-info btn-sm" style="margin: 1px"
                               href="${pageContext.request.contextPath}/views/showRelatedInfo?query=namedEntity.ns:${word}">${word}</a>
                        </c:forEach>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="word-break:break-all; word-wrap:break-word;">
                        <c:forEach items="${webpage.namedEntity.get('nt')}" var="word">
                            <a class="btn btn-outline btn-info btn-sm" style="margin: 1px"
                               href="${pageContext.request.contextPath}/views/showRelatedInfo?query=namedEntity.nt:${word}">${word}</a>
                        </c:forEach>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-outline btn-info" target="_blank"
                           href="${pageContext.request.contextPath}/views/editConfigById?spiderInfoId=${webpage.spiderInfoId}">查看爬虫模板</a>
                    </td>
                </tr>
                <tr>
                    <td>原网站</td>
                    <td>
                        <a class="btn btn-outline btn-info" target="_blank"
                           href="${pageContext.request.contextPath}/views/newsList?domain=${webpage.domain}">查看${webpage.domain}的新闻</a>
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <ul class="list-group">
                <c:forEach items="${relatedWebpageList}" var="relatedWebpage">
                    <li class="list-group-item">
                        <a href="${pageContext.request.contextPath}/views/showWebpageById?id=${relatedWebpage.id}">${relatedWebpage.title}</a>
                    </li>
                </c:forEach>
            </ul>
        </div>
