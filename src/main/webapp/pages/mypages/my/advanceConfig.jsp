...
<link href="${pageContext.request.contextPath}/pages/mypages/css/style.css" rel="stylesheet" type="text/css" />
...
<script src="${pageContext.request.contextPath}/pages/mypages/js2/config.js"></script>
