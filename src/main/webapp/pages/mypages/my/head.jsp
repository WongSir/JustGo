			...
			<div class="wrap " id="head">
				<div class="top-menu">
					<ul>
						...
						<li><a href="${pageContext.request.contextPath}/panel/commons/advanceConfig">高级配置</a></li>
						<li><a href="${pageContext.request.contextPath}/panel/commons/advanceSearch">高级搜索</a></li>
					</ul>
				</div>
				<div class="num">
